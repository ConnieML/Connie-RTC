    ...
    return (
      ...
      <div className="table-row h-1/5;">
        ...
        <form className="p-0 border-[none]">
          <input className="border-2 border-gray-500 rounded-lg w-[150%] pl-10 bg-transparent bg-center bg-no-repeat" type="search" placeholder="Search"></input>
        </form>
        </div>
      ...
      <div className="flex-grow p-20 flex flex-col justify-center mt-20 items-firstBaseline ml-[-91%]">
          ...
          <h2 className="text-[15px] font-[normal] mb-[25px]">Manage your profile here</h2>
          <form className="flex-col gap-[15px] w-full max-w-[300px]" onSubmit={handleFormSubmit}>
            <div>
            ...
            <div>
              ...
              <input
                ...
                <div className="flex justify-end mt-5">
                  <button className="bg-[#705dea] text-white w-[300px] px-5 py-2.5 border-[#e7e7e7]" type="submit">Done</button>
                  <button className="bg-white text-[#d31313] ml-2.5 px-5 py-2.5 border-[#d3d1d1]">Cancel</button>
              </div>
            </div>
          </form>
      </div>
